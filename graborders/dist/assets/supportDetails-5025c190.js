import{al as r,u as s,aj as n,i as l,ak as c,k as e,L as d,j as p}from"./index-f344245a.js";import{u as f}from"./useDispatch-e0abef00.js";function m(){const{id:i}=r(),a=f(),t=s(n.selectRows).find(o=>o.id===i);return l.useEffect(()=>{a(c.doFetch({visibleForCurrentUser:!0}))},[a]),e.jsxs("div",{className:"helpcenterdetail-container",children:[e.jsx("div",{className:"header",children:e.jsxs("div",{className:"nav-bar",children:[e.jsx(d,{to:"/support",className:"back-arrow",children:e.jsx("i",{className:"fas fa-arrow-left"})}),e.jsx("div",{className:"page-title",children:p("pages.helpCenter.title")})]})}),e.jsx("div",{className:"content-card",children:e.jsx("div",{className:"helpcenterdetail-content",children:t&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"question-title",children:t.question}),e.jsx("div",{className:"divider-line"}),e.jsx("div",{className:"answer-content",children:t.description})]})})}),e.jsx("style",{children:`
