import{al as n,u as s,aj as o,i as l,ak as d,k as e,L as c,j as p}from"./index-a47ef697.js";import{u as x}from"./useDispatch-85fd9340.js";function u(){const{id:r}=n(),i=x(),t=s(o.selectRows).find(a=>a.id===r);return l.useEffect(()=>{i(d.doFetch({visibleForCurrentUser:!0}))},[i]),e.jsxs("div",{className:"helpcenterdetail-container",children:[e.jsx("div",{className:"header",children:e.jsxs("div",{className:"nav-bar",children:[e.jsx(c,{to:"/support",className:"back-arrow",children:e.jsx("i",{className:"fas fa-arrow-left"})}),e.jsx("div",{className:"page-title",children:p("pages.helpCenter.title")})]})}),e.jsx("div",{className:"content-card",children:e.jsx("div",{className:"helpcenterdetail-content",children:t&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"question-title",children:t.question}),e.jsx("div",{className:"divider-line"}),e.jsx("div",{className:"answer-content",children:t.description})]})})}),e.jsx("style",{children:`
