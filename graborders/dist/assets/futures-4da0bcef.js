...
`})]}),document.body):null};function We(r){const{countFutures:u,futuretLoading:p,listFutures:f,handleOpenOrderModal:w,formatNumber:E,formatDateTime:R}=r;return e.jsxs("div",{className:"orders-container",children:[u>0&&!p&&(f==null?void 0:f.map(m=>{var N;return e.jsxs("div",{className:"order-card",onClick:()=>w(m),children:[e.jsxs("div",{className:"order-header",children:[e.jsx("div",{className:"order-pair",children:m.futureCoin||"BTC/USD"}),e.jsx("div",{className:`order-direction ${m.futuresStatus==="long"?"buy":"sell"}`,children:m.futuresStatus==="long"?a("pages.futures.actions.buyUp"):a("pages.futures.actions.buyDown")})]}),e.jsxs("div",{className:`order-status ${m.finalized?"closed":"open"}`,children:["● ",m.finalized?a("pages.futures.orderDetails.closed"):a("pages.futures.orderDetails.open")]}),e.jsxs("div",{className:"order-details",children:[e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:a("pages.futures.orderDetails.futuresAmount")}),e.jsxs("span",{className:"order-value",children:["$",m.futuresAmount]})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:a("pages.futures.orderDetails.openPositionPrice")}),e.jsx("span",{className:"order-value",children:E((N=m==null?void 0:m.openPositionPrice)==null?void 0:N.toString(),(m==null?void 0:m.openPositionPrice)>1e3?0:2)})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:a("pages.futures.orderDetails.openPositionTime")}),e.jsx("span",{className:"order-value",children:R(m.openPositionTime)})]}),e.jsxs("div",{className:"order-row",children:[e.jsx("span",{className:"order-label",children:a("pages.futures.orderDetails.leverage")}),e.jsxs("span",{className:"order-value",children:[m.leverage,"x"]})]})]})]},m.id)})),f.length===0&&!p&&e.jsxs("div",{className:"no-orders",children:[e.jsx("i",{className:"fas fa-file-invoice"}),e.jsx("div",{children:a("pages.futures.list.noOrders")})]}),e.jsx("style",{children:` 
                .order-status {
                    font-size: 12px;
                    margin-bottom: 12px;
                }
