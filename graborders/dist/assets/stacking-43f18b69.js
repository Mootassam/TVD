import{n as g,N as pa,j as s,i as m,u as j,t as ma,az as xa,A as ka,aA as ua,aB as I,D as U,k as a,aC as H}from"./index-a23148c8.js";import{u as ha,y as ba,c as fa,F as va}from"./FormErrors-e6dcc768.js";import{y as u}from"./yupFormSchemas-38d196c5.js";import{F as ya}from"./FieldFormItem-198d9347.js";import{S as ja}from"./SubHeader-4c62d704.js";import{D as K}from"./Dates-689c3b73.js";import{S as wa}from"./sucessModal-47eb2454.js";import{u as Na}from"./useDispatch-1da8dfab.js";import"./v4-4a60fe23.js";const p=t=>t.plan.list,Sa=g([p],t=>t.loading),za=g([p],t=>t.exportLoading),C=g([p],t=>t.rows),P=g([p],t=>t.count),Da=g([P],t=>t>0),Ra=g([p],t=>t.sorter||{}),Fa=g([p],t=>{const c=t.sorter;if(!c||!c.field)return null;let h=c.order==="descend"?"DESC":"ASC";return`${c.field}_${h}`}),Ca=g([p],t=>t.filter),Pa=g([p],t=>t.rawFilter),Aa=g([p],t=>t.pagination.pageSize),Ma=g([p],t=>{const c=t.pagination;return!c||!c.pageSize?0:((c.current||1)-1)*c.pageSize}),Ea=g([p,P],(t,c)=>({...t.pagination,total:c})),W=g([p],t=>t.selectedKeys),$a=g([p,C],(t,c)=>c.filter(h=>t.selectedKeys.includes(h.id))),Ta=g([C,W],(t,c)=>t.length===c.length),La={selectLoading:Sa,selectRows:C,selectCount:P,selectOrderBy:Fa,selectLimit:Aa,selectFilter:Ca,selectOffset:Ma,selectPagination:Ea,selectSelectedKeys:W,selectSelectedRows:$a,selectHasRows:Da,selectExportLoading:za,selectRawFilter:Pa,selectIsAllSelected:Ta,selectSorter:Ra},w=t=>t.stacking.form,Ba=g([w],t=>t.record),Oa=g([w],t=>!!t.initLoading),Va=g([w],t=>!!t.saveLoading),Ia=g([w],t=>!!t.showModal),Ua={selectInitLoading:Oa,selectSaveLoading:Va,selectRecord:Ba,selectModal:Ia,selectRaw:w},Ha=pa().shape({user:u.relationToOne(s("entities.stacking.fields.user"),{}),plan:u.relationToOne(s("entities.stacking.fields.plan"),{}),amount:u.decimal(s("entities.stacking.fields.amount"),{required:!0}),status:u.enumerator(s("entities.stacking.fields.status"),{options:["active","completed","cancelled"]}),startDate:u.datetime(s("entities.stacking.fields.startDate"),{}),endDate:u.datetime(s("entities.stacking.fields.endDate"),{}),earnedRewards:u.decimal(s("entities.stacking.fields.earnedRewards"),{})});function Za(){const[t,c]=m.useState("options"),[h,A]=m.useState(!1),k=Na(),f=j(La.selectRows),q=j(ma.selectCurrentUser),z=j(xa.selectRows),N=j(ka.selectRows),[D,Y]=m.useState({}),[M,E]=m.useState({}),[_,G]=m.useState(""),$=j(Ua.selectModal),J=()=>{k(H.doClose())},[r,Q]=m.useState({crypto:"",daily:"",balance:0,min:0,max:0,symbol:"",plan:"",unstakingPeriod:""}),[b,R]=m.useState(""),[X]=m.useState(()=>({user:"",plan:"",amount:"",status:"",startDate:"",endDate:"",earnedRewards:""})),v=ha({resolver:ba.yupResolver(Ha),mode:"all",defaultValues:X}),T=fa({control:v.control,name:"amount",defaultValue:""}),Z=()=>{if(N&&N.length>0){const e=N.reduce((n,i)=>(i.symbol&&i.amount!==void 0&&(n[i.symbol]=parseFloat(i.amount)||0),n),{});E(e)}};m.useEffect(()=>{R(T||"")},[T]),m.useEffect(()=>{Z()},[N]);const aa=async e=>{e.startDate=new Date;const n=new Date(e.startDate);n.setDate(n.getDate()+parseInt(r.unstakingPeriod)),e.endDate=n.toISOString(),e.status="active",e.plan=r.plan,e.user=q.id,G(e.amount);try{await k(H.doCreate(e)),k(U.doFetch()),k(I.doFetch()),E(i=>({...i,[r.symbol]:(i[r.symbol]||0)-parseFloat(b)})),L()}catch(i){console.error("Staking failed:",i)}},ea=()=>{if(!b||isNaN(b)||b<=0)return"0";const e=parseFloat(b),n=parseFloat(r.daily),i=parseFloat(r.unstakingPeriod);return(e*(n/100)*i).toFixed(6)},sa=()=>{const e=parseFloat(b),n=M[r.symbol]||0;return isNaN(e)||e<=0?{isValid:!1,message:s("stake.enterAmount")}:e>n?{isValid:!1,message:s("stake.insufficientBalance")}:e<r.min?{isValid:!1,message:s("stake.minAmount",{min:r.min})}:e>r.max?{isValid:!1,message:s("stake.maxAmount",{max:r.max})}:{isValid:!0,message:s("stake.confirmStake")}},ta=(e,n,i,l,o,d,x,S)=>{Q({crypto:e,daily:n,balance:i,min:l,max:o,symbol:d,plan:x,unstakingPeriod:S}),A(!0),R(""),v.setValue("amount","")},L=()=>{A(!1),R(""),v.setValue("amount","")},na=async()=>{try{const n=[...new Set(f.map(o=>o.currency))].map(async o=>{if(o==="USD")return{currency:o,price:1};try{const x=await(await fetch(`https://api.binance.com/api/v3/ticker/price?symbol=${o}USD`)).json();return{currency:o,price:parseFloat(x.price)}}catch(d){return console.error(`Error fetching price for ${o}:`,d),{currency:o,price:0}}}),i=await Promise.all(n),l={};i.forEach(o=>{l[o.currency]=o.price}),Y(l)}catch(e){console.error("Error fetching crypto prices:",e)}},F=z.filter(e=>e.status==="active"),y=z.filter(e=>e.status==="completed"),ia=()=>{let e=0;return F.forEach(n=>{var d;const i=(d=n==null?void 0:n.plan)==null?void 0:d.currency,l=parseFloat(n.amount)||0,o=D[i]||0;e+=l*o}),e.toFixed(2)},oa=()=>{let e=0;return z.forEach(n=>{var d;const i=(d=n==null?void 0:n.plan)==null?void 0:d.currency,l=parseFloat(n.earnedRewards)||0,o=D[i]||0;e+=l*o}),e.toFixed(2)},ca=()=>{let e=0;return y.forEach(n=>{var d;const i=(d=n==null?void 0:n.plan)==null?void 0:d.currency,l=parseFloat(n.earnedRewards)||0,o=D[i]||0;e+=l*o}),e.toFixed(2)};m.useEffect(()=>(k(ua.doFetch()),k(I.doFetch()),k(U.doFetch()),()=>{}),[k]),m.useEffect(()=>{f.length>0&&na()},[f]);const B=sa(),O=!B.isValid,ra=B.message,la=e=>{const n=new Date,i=new Date(e.startDate);return Math.floor((n.getTime()-i.getTime())/(1e3*60*60*24))},da=e=>{const n=new Date,i=new Date(e.endDate),l=Math.floor((i.getTime()-n.getTime())/(1e3*60*60*24));return Math.max(0,l)},ga=()=>M[r.symbol]||0;return a.jsxs("div",{className:"stacking-container",children:[a.jsx("style",{children:`
        .stacking-container {
          max-width: 400px;
          margin: 0 auto;
