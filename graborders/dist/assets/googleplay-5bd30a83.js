import{i as o,p as I,k as a,L as F}from"./index-0f3b9b98.js";function A(){const[c,p]=o.useState(null),[n,h]=o.useState(!1),[f,t]=o.useState(!1),[l,d]=o.useState(!1),[g,r]=o.useState(!1),b=I(),j=[{src:"/playsotre/6.png",label:"Crypto Staking"},{src:"/playsotre/1.png",label:"Fast Withdrawals"},{src:"/playsotre/2.png",label:"Crypto Staking"},{src:"/playsotre/3.png",label:"Crypto Staking"},{src:"/playsotre/4.png",label:"Portfolio"},{src:"/playsotre/chat.png",label:"24/7 Support"}],u=e=>{p(e)},x=()=>{p(null)},v=()=>{t(!0)},N=async()=>{d(!0);try{const e="https://icmarketsindia.com/apk/icmarketsindia.apk",s=document.createElement("a");s.href=e,s.download="icmarketsindia.apk",document.body.appendChild(s),s.click(),document.body.removeChild(s),setTimeout(()=>{d(!1),t(!1)},2e3)}catch(e){console.error("Download failed:",e),d(!1)}},w=e=>{e.target.closest(".screenshot")||e.target.closest(".install-button")||e.target.closest(".share-button")||e.target.closest(".back-button")||t(!0)},i={title:"IC Markets - Trading App",text:"Check out IC Markets - The ultimate trading platform for cryptocurrency and forex markets. Trade Bitcoin, Forex, and more with advanced tools!",url:"https://icmarketsindia.com/playgoogle",apkUrl:"https://icmarketsindia.com/apk/icmarketsindia.apk"},k=()=>{const e=`${i.title}
