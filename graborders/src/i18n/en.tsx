...
const en = {
  ...
  pages: {
    ...
    withdraw: {
      ...
      announcement: "The minimum withdrawal amount is $10. All withdrawals are processed within 30 minutes.",
      ...
      rules: {
        minimum: "(1) Minimum withdraw is $10",
      ...
      amountPlaceholder: "Enter amount (min. $10)",
