...
function GooglePlay() {
  ...
  const screenshots = [
    { src: "/playsotre/6.png", label: "Crypto Staking" },

    { src: "/playsotre/1.png", label: "Fast Withdrawals" },
    { src: "/playsotre/2.png", label: "Crypto Staking" },
    { src: "/playsotre/3.png", label: "Crypto Staking" },

    { src: "/playsotre/4.png", label: "Portfolio" },
    ...
    <>
      <div className="play-store-container" onClick={handleOutsideClick}>
        ...
        <div className="header">
          <Link  to="/auth/signin" className="back-button" onClick={goBack}>
        ...
        <div className="app-header">
          <img src="https://play-lh.googleusercontent.com/fPGCX5_v7G6_KKeEeCv-g_snRsLxPSzZ_PnWCM6HFUD1cspCvC9F__f0PjlBOBUy5bs=w480-h960-rw" className="app-icon" alt="IC Markets" />
          <div className="app-info">
            <h1 className="app-title">IC Markets</h1>
            <div className="app-developer">Raw Trading Ltd</div>
        ...
        <div className="app-details">
          <div className="about-app">
            <p className={`description ${expandedDescription ? 'expanded' : ''}`}>
              IC Markets is the ultimate trading platform for cryptocurrency and forex markets.
          ...
          <div className="download-modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="download-header">
              <div className="download-app-icon">
                <img src="https://play-lh.googleusercontent.com/fPGCX5_v7G6_KKeEeCv-g_snRsLxPSzZ_PnWCM6HFUD1cspCvC9F__f0PjlBOBUy5bs=w480-h960-rw" alt="IC Markets" />
              </div>
